    ...
    <div class="container hero-layout">
      ...
      <div class="hero-container">
        ...
        <div class="hero-social fade-in">
          ...
          <a href="https://www.linkedin.com/in/runmao-yao-765358305" aria-label="LinkedIn">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.447-2.136 2.941v5.665H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.063 2.063 0 1 1 0-4.126 2.063 2.063 0 0 1 0 4.126zM7.119 20.452H3.554V9h3.565v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z"/></svg>
          </a>
          <a href="images/wechat.jpg?v=20260601" class="wechat-link" aria-label="WeChat: yaorunmao" title="WeChat: yaorunmao">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55l-.74 2.44 2.96-1.424c1.06.35 2.23.542 3.469.542.278 0 .552-.01.823-.029a6.42 6.42 0 0 1-.139-1.33c0-3.94 3.857-7.133 8.617-7.133.19 0 .378.005.564.015-.744-3.405-4.85-5.973-9.865-5.973zM5.89 6.747a.992.992 0 1 1 0 1.984.992.992 0 0 1 0-1.984zm5.595 0a.992.992 0 1 1 0 1.984.992.992 0 0 1 0-1.984zM17.992 9.25c-3.84 0-6.957 2.704-6.957 6.03s3.116 6.03 6.957 6.03c.969 0 1.891-.172 2.727-.483L23.06 22l-.586-2.01C23.412 18.91 24 17.485 24 15.28c0-3.326-3.116-6.03-6.008-6.03zm-2.315 3.788a.827.827 0 1 1 0 1.654.827.827 0 0 1 0-1.654zm4.631 0a.827.827 0 1 1 0 1.654.827.827 0 0 1 0-1.654z"/></svg>
            <span class="wechat-qr" aria-hidden="true">
              <img src="images/wechat.jpg?v=20260601" alt="">
              <span>WeChat: yaorunmao</span>
            </span>
          </a>
          <a href="https://x.com/yaorunmao" aria-label="X">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.293 19.491h2.039L6.486 3.24H4.298l13.31 17.404z"/></svg>
          </a>
        </div>
      </div>
    </div>
        ...
        <article class="pub-card">
          ...
          <div class="pub-info">
            ...
            <div class="pub-links">
              ...
              <a href="https://Ropedia.github.io/S-Agent">Project</a>
            </div>
          </div>
        </article>
